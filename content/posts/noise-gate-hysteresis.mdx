...
![Noise gate hysteresis — two threshold lines prevent chattering in microphone recording](/images/noise-gate-hysteresis.webp "How hysteresis in WaveDisco noise gate prevents chattering during vocal recording")
